...
func (l *LogEntry) All() ([]*LogEntry, error) {
	...
	// with mongo we can not deal with raw datas
	var logs []*LogEntry
	for cursor.Next(ctx) {
		var item *LogEntry
...
func (l *LogEntry) GetOne(id string) (*LogEntry, error) {
	...
	// convert the id parameter to the mongodb format
...
// if many collection, pass the name of the collection as parameter
