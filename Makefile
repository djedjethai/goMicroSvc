...
## build_front: build the front-end binary as a linux executable
build_front_end:
	@echo "Building front binary..."
...
build_listener:
	...
	cd ./listener-svc/bin && env GOOS=linux CGO_ENABLED=0 go build -o ${LISTENER_BINARY} ../cmd
	@echo "Done!"
